...
public class AdminController:Controller
{
    ...
    public AdminController(ILogger<AdminController> logger, IProductService productService, ICategoryService categoryService, IBrandService brandService, IMapper mapper)
    {
        _logger = logger;
