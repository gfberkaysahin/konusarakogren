...
public class CustomerController:Controller
{
    ...
    public CustomerController(ILogger<CustomerController> logger, IProductService productService, ICategoryService categoryService, IBrandService brandService, IMapper mapper)
    {
        _logger = logger;
